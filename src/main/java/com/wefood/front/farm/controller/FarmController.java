...
public class FarmController {
    ...
    @GetMapping
    public String getFarms(Model model, @RequestParam(name = "page", defaultValue = "0") Long page, @RequestParam(name = "size", defaultValue = "9") Long size) {
    ...
    @GetMapping("/{id}")
    public String getFarm(@PathVariable("id") Long id, Model model, @CookieValue(name = "isSeller", required = false) Boolean isSeller, @RequestParam(name = "page", defaultValue = "0") Long page, @RequestParam(name = "size", defaultValue = "9") Long size) {
